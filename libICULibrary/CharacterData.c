...
DLLEXPORT int icuCharacterName(
...
DLLEXPORT int icuCharacter_charAge(
		WolframLibraryData libData, mint argc,
		MArgument *args, MArgument res)
{
	UChar32 c;
...
DLLEXPORT int icuCharacter_getNumericValue(
		WolframLibraryData libData, mint argc,
		MArgument *args, MArgument res)
{
	UChar32 c;
...
DLLEXPORT int icuUnicodeVersion(
		WolframLibraryData libData, mint argc,
		MArgument *args, MArgument res)
{
	UVersionInfo versionArray; // array of 4 uint8_t
...
DLLEXPORT int icuCharacterBinaryProperty(
		WolframLibraryData libData, mint argc,
		MArgument *args, MArgument res)
{
	UChar32 c;
...
// Check a binary Unicode property for a code point.
DLLEXPORT int icuCharacterBoolProperty(
		WolframLibraryData libData, mint argc,
		MArgument *args, MArgument res)
{
	UChar32 c;
...
DLLEXPORT int icuCharacterIntProperty(
		WolframLibraryData libData, mint argc,
		MArgument *args, MArgument res)
{
	UChar32 c;
...
DLLEXPORT int icuCharacterCharProperty(
		WolframLibraryData libData, mint argc,
		MArgument *args, MArgument res)
{
	UChar32 c;
...
DLLEXPORT int icuCharacterCPOSIXTestProperty(
		WolframLibraryData libData, mint argc,
		MArgument *args, MArgument res)
{
	UChar32 c;
...
DLLEXPORT int icuCharacterICUWhitespaceTestProperty(
		WolframLibraryData libData, mint argc,
		MArgument *args, MArgument res)
{
	UChar32 c;
...
DLLEXPORT int icuCharacterICUTestProperty(
		WolframLibraryData libData, mint argc,
		MArgument *args, MArgument res)
{
	UChar32 c;
