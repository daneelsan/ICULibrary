...
ICULibrary::nolibiculibrary = "libICULibrary (``) could not be found, some functionality will not be available.";

$libraryFile = $ICULibraryLibraryPath;

If[!StringQ[$libraryFile] || !FileExistsQ[$libraryFile],
  Message[ICULibrary::nolibiculibrary, $libraryFile];
  $libraryFile = $Failed;
];

(* Load libICULibrary functions *)
